...
def test_if_labels_are_visible_after_hover():
    browser = webdriver.Firefox()
    browser.get('https://xeokit.github.io/xeokit-sdk/examples/annotations/#annotations_hoverShowLabels')
    time.sleep(2)
    ...
    for i in range(3):
        ...
        hover = ActionChains(browser).move_to_element(annotation_marker)
        hover.perform()
        time.sleep(0.5)
