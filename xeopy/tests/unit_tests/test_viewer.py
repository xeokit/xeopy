...
def test_init_default():
    ...
    assert viewer.variable_name == "viewer"
...
def test_init_all_filled():
    viewer = Viewer(variable_name="another_viewer", canvas_id="another_canvas", transparent=False, dtx_enabled=False)

    assert viewer.variable_name == "another_viewer"
